...
import cors from 'cors'                       //módulo para desbloquear las politicas  del cors (origenes cruzados: server del front 5173 y del back 8080)
...
app.use(cors());                                           //obligo al servidor a desbloquear la politicas de origenes cruzados
